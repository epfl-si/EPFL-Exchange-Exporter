...
const describeTestResource = require('./func/Connected/Form/Resource/Describe/testResource')
...
describe('Welcome page connected (form)', () => {
  ...
  it('Check default values : resource', () => {
    cy.get("input#floating_outlined_resource").then(val => expect(val).to.be.empty)
  })
