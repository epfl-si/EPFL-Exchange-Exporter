export default ({isLastMissing, isClickedSetter, label, ref=null}) => {
  return (
    <button ref={ref} className="bg-[#FF0000] hover:bg-[#c90000] active:bg-[#B51F1F] text-white font-bold py-2 px-4 rounded inline-flex items-center" type="submit" onClick={()=> {if (isLastMissing){isClickedSetter(true)}}}>
