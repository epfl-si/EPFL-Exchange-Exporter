...
export default ({data, label}) =>{
    ...
    return (
        <>
            <button className="bg-gray-500 hover:bg-gray-600 active:bg-gray-700 text-white font-bold py-2 px-4 rounded inline-flex items-center" type="button" onClick={() => setPopupOpen(true)}>
