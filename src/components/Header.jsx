...
const Header = () =>{
    ...
    return (
        <header className="bg-white flex justify-between items-center gap-4 text-xl min-h-20 shadow-[0_3px_1px_-2px_#0003,_0_2px_2px_#00000024,_0_1px_5px_#0000001f] p-4 text-black z-10">
