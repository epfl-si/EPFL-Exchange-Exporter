...
EEEE stand for EPFL Exchange Events Exporter. This app is used to return all calendars event of ressources (conference room, materials..), inside a data file as csv, json...
